...
<head>
    ...
    <title>masaage Shop || BarberShop Hair Salon HTML Template</title>
                        ...
                        <div class="subscribe_form">
                            <form action="#" class="subscribe_form">
                                <input type="email" name="email" id="subs-email" class="form_input"
                                    ...
                                    <button type="submit" class="submit" onclick="location.href='subscribed.html'">SUBSCRIBE</button>                                <div class="clearfix"></div>
